...
(function () {
    ...
    function updateStoryMusicTrimUI() {
        ...
        const safeWindow =
            Math.min(windowDuration, duration);
    ...
    function setupStoryMusicMediaPreview() {
        ...
        if (
            ...
            /* STORY MUSIC = ORIGINAL VIDEO AUDIO OFF */
            video.muted = true;
    ...
    function setupStoryMusicTrimAudio() {
        ...
        /* Story Music trim audio must be audible */
        audio.muted = false;
        audio.volume = 1;
        ...
        /*
           STORY MUSIC FIXED SELECTION WINDOW

           Photo  = 15 seconds
           Video  = 30 seconds

           This is ONLY the selected music
           window. The complete song duration
           remains separate in state.duration.
        */
        ...
        try {
            ...
            console.log(
                "STORY MUSIC MEDIA TYPE LOOKUP ERROR =",
                error
            );
        }
        ...
        window.snapzStoryMusicTrimState = {
            ...
            /* CURRENT POSITION INSIDE FULL SONG */
            start: 0,
    ...
    function bindStoryMusicTrimHandles() {
        ...
        function updateFromPointer(clientX) {
            ...
            */
            ...
            /*
               The selection window remains
               fixed at 15 sec / 30 sec.
        ...
        selected.addEventListener(
            ...
            function (e) {
                ...
                try {
                    ...
                    console.log(
                        "STORY TRIM POINTER CAPTURE ERROR =",
                        error
                    );
                }
        ...
        console.log(
            "SNAPZ STORY MUSIC FULL SONG CENTER DRAG READY"
        );
    }
