...
(function () {
    ...
    function setupInstagramTrimControls() {
        ...
        /*
         * IMPORTANT:
         * Start/End handle ko chhodkar
         * selected area par tap karne se
         * playhead/timing set hoti hai.
         */
        ...
        selected.addEventListener(
            ...
            function (event) {
                ...
                /*
                 * Selected range ke bahar
                 * timing set nahi hogi.
                 */
        ...
        /*
         * Timeline par selected region ke
         * bahar tap bhi nearest boundary par
         * playhead set karega.
         */
...
function createInstagramWaveform() {
     ...
     *
     * Do NOT use 30 seconds as the timeline duration.
     *
     * Example:
     * Music = 180 sec
     *
     * Timeline = 180 sec
     * Selected area = max 30 sec for Post
     */
    ...
    /*
     * Remove old waveform graphics only.
     */
     ...
     *
     * It is visual only.
     * The actual time is controlled by
     * start/end handles and selected area.
     */
    ...
    for (
         ...
         * No random movement every render.
         */
    ...
    /*
     * IMPORTANT:
     * The selected area represents ONLY the
     * current trim window.
     */
    ...
    /*
     * Store duration on timeline so the
     * middle-area drag system can use the
     * COMPLETE song duration.
     */
...
function setupTrim(allowedDuration) {
    ...
    const start =
        document.getElementById("snapzTrimStart");

    const end =
        document.getElementById("snapzTrimEnd");
     ...
     * IMPORTANT:
     *
     * Slider/timeline ALWAYS represents the FULL MUSIC.
     *
     * allowedDuration is ONLY the maximum selectable window.
     *
     * Therefore:
     *   Post = maximum 30 seconds
     *   Reel = actual Reel duration
     *
     * The music itself is NEVER shortened here.
     */
    ...
    /*
     * Initial selected window starts at 0.
     *
     * IMPORTANT:
     * End handle is placed at the maximum allowed
     * trim length, NOT at the end of the song.
     */
...
function updateTrim() {
    ...
    /*
     * Never allow selected area to become longer
     * than Post/Reel allowed duration.
     */
    ...
    /*
     * Move the Instagram-style selected window.
     */
